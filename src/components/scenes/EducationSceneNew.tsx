...
const EducationSceneNew = () => {
  return (
    <section className="relative min-h-full w-full overflow-y-auto overflow-x-hidden cinema-gradient flex items-start md:items-center py-12 md:py-8 lg:py-0" data-scroll-container>
      {/* Background logo */}
      <motion.div
